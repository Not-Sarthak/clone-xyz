...
const Footer = () => {
  const sections = {
    solutions: {
      title: "Solutions",
      items: [
        { label: "No Code Agents", href: "#" },
        { label: "Social Integrations", href: "#" },
    ...
    <div className="px-4 xl:px-0">
      ...
      >
        ...
        <div className="mr-auto flex w-full justify-between lg:w-fit lg:flex-col">
          ...
          >
            <CloneLogo className="ml-2 w-10" />
            <div className="text-lg font-semibold text-[#F97316]">Clone</div>
          </Link>
